...
from self_group import calc_interest
...
class Member(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        get_main_group_total = get_object_or_404(Main_group_total, pk=2)
...
class Groupday(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('self_group:members')


# ================================Unga
class Unga(models.Model):
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="unga_set")
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="unga_set")
    ...
    def save(self, *args, **kwargs):
        ...
        if self.has_paid == True:
            amount = self.amount
            unga_total_object = get_object_or_404(Unga_total, pk=2)
...
class Unga_loan(models.Model):
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="ungaloan_set")
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="ungaloan_set")
...
class Unga_loan_progress(models.Model):
    loan = models.ForeignKey(Unga_loan, on_delete=models.CASCADE, related_name="ungaloanprogress_set")
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="ungaloanprogress_set")
...
class Unga_fines_interests(models.Model):
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="ungafines_set")
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="ungafines_set")
...
class Main_group_merrygoround(models.Model):
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="merry_set")
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="merry_set")
    has_paid = models.BooleanField()
...
class Main_group_loan(models.Model):
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="grouploan_set")
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="grouploan_set")
    amount = models.PositiveIntegerField()
...
class Main_group_loan_proress(models.Model):
    loan = models.ForeignKey(Main_group_loan, on_delete=models.CASCADE, related_name="grouploanprocess_set")
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="grouploanprocess_set")
    month = models.CharField(max_length=1, choices=((i, i) for i in range(1, 4)))
    has_paid_interest = models.BooleanField()
    has_paid_all = models.BooleanField(default=False)
...
class Main_group_fines_interest(models.Model):
    date = models.ForeignKey(Groupday, on_delete=models.CASCADE, related_name="groupfines_set")
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name="groupfines_set")
